...
const CrystalViewPitchDeck = () => {
  return (
    <div className="pitch-deck-container">
      {/* Hero Section */}
      <section className="hero min-h-screen bg-gradient-to-r from-accent-neon to-cool-blue">
            ...
            <div className="card-body">
              <div className="stats shadow mb-8">
                <div className="stat">
                  ...
                  <div className="stat-title">Global CAGR</div>
                  <div className="stat-value text-secondary">~25%</div>
                  <div className="stat-desc">Annual Growth Rate</div>
                </div>
                ...
                <div className="stat">
                  ...
                  <div className="stat-title">India Opportunity</div>
                  <div className="stat-value text-primary">₹35,000 Cr+</div>
                  <div className="stat-desc">Across sectors</div>
                </div>
                ...
                <div className="stat">
                  ...
                  <div className="stat-title">Global Market</div>
                  <div className="stat-value text-accent">$10B+</div>
                  <div className="stat-desc">By 2030</div>
                </div>
              </div>
